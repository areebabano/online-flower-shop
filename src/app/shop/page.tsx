...
const FlowerShopSection: React.FC = () => {
  ...
  return (
    <div className="bg-white text-gray-900 font-serif pt-20">
      {/* Hero Section */}
      ...
      <section className="p-6 flex justify-between items-center border-b">
        ...
        <section className="bg-gradient-to-r from-pink-500 to-pink-700 p-6 border-t flex justify-center items-center text-center space-x-4">
        <div>
